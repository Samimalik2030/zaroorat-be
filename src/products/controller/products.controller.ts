...
export class ProductController {
  ...
  @ApiResponse({
    status: 200,
    description: 'List of products by tags',
    type: [Product],
  })
  @ApiResponse({
    status: 404,
    description: 'No products found with these tags',
  })
  ...
  @Post()
  async getFinalAmount(@Body() body: CalculateAmountDto) {
    return await this.productService.calculteAmount(body)
  }
  ...
  async calculateEstimate(
    ...
    return await this.productService.getEstimateCost(body)
  }
}
